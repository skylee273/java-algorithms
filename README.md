...
* **Input&Output** - 
    ...
    * `B` [[백준] - 10991 별 찍기 - 16](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_10991.java)
    * `B` [[백준] - 10992 별 찍기 - 17](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_10992.java)
...
* **Dynamic Programming** - Dynamic programming is both a mathematical optimization method and a computer programming method. The method was developed by Richard Bellman in the 1950s and has found applications in numerous fields, from aerospace engineering to economics.
    ...
    * `R` [[백준] - 1463 1로 만들기](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_1463.java)
    * `R` [[백준] - 11726 2×n 타일링](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_11726.java)
...
* **Graph** - DAn undirected graph is connected if every pair of vertices is connected by a path. A forest is an acyclic graph, and a tree is a connected acyclic graph. A graph that has weights associated with each edge is called a weighted graph. Graphs can be represented by their adjacency matrix or an edge (or vertex) list.
    * `B` - Beginner, `I` - Intermediate, `A` - Advanced, `R` - Repect
    * `B` [[백준] - 1260 DFS와 BFS](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_1260.java)
    * `B` [[백준] - 11724 연결 요소의 개수](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_1260.java)
    * `IRR` [[백준] - 1707 이분 그래프 ](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_1707.java)
    * `B` [[백준] - 10451 순열 사이클 ](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_10451.java)
    * `B` [[백준] - 2331 반복수열 ](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_2331.java)
    * `B` [[백준] - 11725 트리의 부모 찾기 ](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_11725.java)
    * `B` [[백준] - 1991 트리 순회 ](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_1991.java)
    * `I` [[백준] - 2146 다리 만들기 ](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_2146.java)
    ...
    * `B` [[백준] - 7576 토마토 ](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_7576.java)
    * `I` [[백준] - 1167 트리의 지름 ](https://github.com/skylee273/java-algorithms/blob/master/BackJoon/src/BackJoon_1167.java)
    ...
    * `B` [[백준] - 10026 적록색약 ](https://github.com/skylee273/java-algorithms/blob/master/Samsung/src/BackJoon_10026.java)
    * `R` [[백준] - 1987 알파벳 ](https://github.com/skylee273/java-algorithms/blob/master/Samsung/src/BackJoon_1987.java)
    ...
    * `B` [[백준] - 7569 토마토 ](https://github.com/skylee273/java-algorithms/blob/master/Samsung/src/BackJoon_7569.java)
    ...
    * `R` [[백준] - 9205 맥주 마시면서 걸어가기 ](https://github.com/skylee273/java-algorithms/blob/master/Samsung/src/BackJoon_9205.java)
    * `R` [[백준] - 1068 트리 ](https://github.com/skylee273/java-algorithms/blob/master/Samsung/src/BackJoon_1068.java)
    * `B` [[백준] - 5014 스타트링크 ](https://github.com/skylee273/java-algorithms/blob/master/Samsung/src/BackJoon_1068.java)
    * `R` [[백준] - 2573 빙산 ](https://github.com/skylee273/java-algorithms/blob/master/Samsung/src/BackJoon_2573.java)
    * `R` [[백준] - 1937 욕심쟁이 판다 ](https://github.com/skylee273/java-algorithms/blob/master/Samsung/src/BackJoon_1937.java)
    * `R` [[백준] - 16234 인구 이동 ](https://github.com/skylee273/java-algorithms/blob/master/Samsung/src/BackJoon_16234.java)
    * `R` [[백준] - 14502 연구소 ](https://github.com/skylee273/java-algorithms/blob/master/Samsung/src/BackJoon_14502.java)
    * `R` [[백준] - 1389 케빈 베이컨의 6단계 법칙 ](https://github.com/skylee273/java-algorithms/blob/master/Samsung/src/BackJoon_1389.java)
 ...
 * **Input & OutPut**
    * [2557](https://www.acmicpc.net/problem/2557),
    ...
    [2558](https://github.com/skylee273/Algorithm/tree/master/Battle95_2),[10950](https://www.acmicpc.net/problem/10950),
 ...
 * **Basic**
    * [2751](https://www.acmicpc.net/problem/2751),
    ...
    [1850](https://www.acmicpc.net/problem/1850),
